...
import {
  ...
  Calculator, Users, LogOut, Bell, TrendingUp, Settings, Pencil, LayoutDashboard, SlidersHorizontal, FileText, HardDrive, Receipt, ShoppingBag
} from "lucide-react";
...
const navItemsAdmin = [
  ...
  { href: "/gastos",               label: "Gastos",             icon: ShoppingBag, group: "finanzas"  },
];
